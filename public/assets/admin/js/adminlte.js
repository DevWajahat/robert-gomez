...
function toggleTimeContainer() {
  if (searchBlock.classList.contains("navbar-search-open")) {
...
const observer = new MutationObserver(toggleTimeContainer);

observer.observe(searchBlock, {
  attributes: true,
...
document.querySelectorAll(".assign-card").forEach(function (card, index) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initAssignCard(card, index = 0) {
    const togglerBtn = card.querySelector(".toggler-btn");
    const toggleIcon = card.querySelector(".rotate-icon");
    const eyeBtn = card.querySelector(".eye-btn");
    const otherDesc = card.querySelector(".other-desc-area");
    ...
    const agentSelect = card.querySelector(".toggler-btn-wrapper select");
  ...
  document.querySelectorAll(".assign-card").forEach((card, i) => {
    initAssignCard(card, i);
  });
...
//           <div>
//               <p><span>Insurance:</span> ${data.insurance}</p>
//               <div class="other-desc-area hidden-class">
//                   <p><span>Owner</span> ${data.owner}</p>
//                   <p><span>Owner Phone:</span> ${data.phone}</p>
//                   <p><span>Owner Email:</span> ${data.email}</p>
//                   <p><span>Claim#:</span> ${data.claim}</p>
//                   <p><span>Type of Claim:</span> ${data.claimType}</p>
//                   <p><span>Loss Type:</span> ${data.lossType}</p>
//                   <p><span>Vehicle Location:</span> ${data.location}</p>
//                   <p><span>Appointment:</span> ${data.appointment}</p>
//               </div>
//           </div>
//           <div>
//               <p class="text-end m-0">Just now</p>
