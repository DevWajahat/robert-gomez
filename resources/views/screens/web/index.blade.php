                ...
                <div class="table-head-wrap">
                    ...
                    <div class="assign-table-wrapper">
                        <table class="assign-table assign-table-1 table">
                            <thead>
                                <tr>
                                    <th scope="col"><input type="checkbox" class="slaveCheckbox" id="masterCheckbox1"> <i class="fa-solid fa-arrow-down"></i>
                                    </th>
                            ...
                            <tbody class="table-bodys" style="cursor: pointer;">
                                <tr class="text-center table-row-first">
                                    <th scope="row" style="align-content: center;"><input type="checkbox" class="slaveCheckbox"></th>
